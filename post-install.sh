...
sudo pacman -S nmap firefox neovim base-devel git intel-ucode gnu-netcat metasploit exploitdb ffuf burpsuite code thunar obsidian zsh net-tools ttf-font-awesome fastfetch rofi brightnessctl pamixer hashcat seclists waybar openvpn hydra discord vivaldi bluez bluez-utils blueberry mousepad signal-desktop --noconfirm
